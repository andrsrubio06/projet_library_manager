...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>D�tails du membre # ${membre.id}</h5> <!-- TODO : remplacer 007 par l'id du membre -->
        <div class="row">
	      <form action="/TP3Ensta-1.0-SNAPSHOT/membre_details?id=${membre.id}" method="post" class="col s12"> <!-- TODO : remplacer idDuMembre par l'id du membre -->
	        <div class="row">
	      ...
	      <form action="/TP3Ensta-1.0-SNAPSHOT/membre_delete" method="get" class="col s12">
