...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>Details du livre # ${livre.id}</h5>
        <div class="row">
	      <form action="/TP3Ensta-1.0-SNAPSHOT/livre_details?id=${livre.id}" method="post" class="col s12"> <!-- TODO : remplacer idDuLivre par l'id du livre -->
	        <div class="row">
	      ...
	      <form action="/TP3Ensta-1.0-SNAPSHOT/livre_delete" method="get" class="col s12">
